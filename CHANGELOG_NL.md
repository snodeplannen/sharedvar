...
### Changed
- **Documentatie Standaardisatie**: Taalconventies voor het project streng gestandaardiseerd, met Engels als de primaire (`.md`) en Nederlands als secundaire (`_NL.md`) opslag. Toegepast over de gehele repository.
